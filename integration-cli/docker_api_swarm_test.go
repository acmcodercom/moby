...
func (s *DockerSwarmSuite) TestAPISwarmLeaderElection(c *check.C) {
	...
	// wait for rejoin here
	c.Logf("Waiting for rejoin...")
	waitAndAssert(c, defaultReconciliationTimeout, d1.CheckLocalNodeState, checker.Equals, swarm.LocalNodeStateActive)
